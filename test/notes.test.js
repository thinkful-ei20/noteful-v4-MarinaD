...
describe('Noteful API - Notes', function () {
  ...
  describe('GET /api/notes', function () {
      ...
      return Promise.all([
        ...
        .then(([data, res]) => {
          ...
          res.body.forEach(function (item) {
            ...
            expect(item).to.have.keys('userId', 'id', 'title', 'content', 'createdAt', 'updatedAt', 'folderId', 'tags');
          });
        });
    });
    ...
    it('should return correct search results for a searchTerm query', function () {
      ...
      return Promise.all([
        Note.find({ title: { $regex: searchTerm }, userId : user.id }),
    ...
    it('should return correct note', function () {
      ...
      return Note.findOne({userId : user.id})
        ...
        .then((res) => {
          ...
          expect(res.body).to.have.keys('userId','id', 'title', 'content', 'createdAt', 'updatedAt', 'folderId', 'tags');
    ...
    it('should create and return a new item when provided valid data', function () {
      ...
      return chai.request(app)
        ...
        .then(function (_res) {
          ...
          expect(res.body).to.have.keys('userId','id', 'title', 'content', 'createdAt', 'updatedAt', 'tags');
